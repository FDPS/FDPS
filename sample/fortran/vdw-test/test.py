...
class Automatic_Tester:
    ...
    def create_tests(self):
        ...
        FCFLAGS = ["-std=f2003 -O3", \
                   "-std=f2003 -O3"]
        CXXFLAGS = ["-std=c++11 -O3 -DPARTICLE_SIMULATOR_MPI_PARALLEL -DPARTICLE_SIMULATOR_THREAD_PARALLEL -fopenmp", \
    ...
    def test(self):
        ...
        text = """
        ###################################################
           Summary of tests for sample/fortran/vdw-test
        ###################################################
        """
        text = text[1:].rstrip()
        text = textwrap.dedent(text)
