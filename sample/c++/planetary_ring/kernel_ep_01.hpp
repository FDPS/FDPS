...
__m256 pg1;
__m256 pg0;
pg1 = _mm256_cmp_ps(EPI_pos.v0,EPJ_pos.v0,_CMP_EQ_OQ);
pg0 = pg1;
...
int index_gather_load3[8] = {0,7,14,21,28,35,42,49};
...
__fkg_tmp_accum = _mm256_i32gather_ps(((float*)&force[i+0].acc_dash.x),vindex_gather_load6,4);
...
__fkg_tmp_accum = _mm256_i32gather_ps(((float*)&force[i+0].acc_dash.y),vindex_gather_load7,4);
...
__fkg_tmp_accum = _mm256_i32gather_ps(((float*)&force[i+0].acc_dash.z),vindex_gather_load8,4);
...
__fkg_tmp_accum = _mm256_i32gather_ps(((float*)&force[i+0].pot),vindex_gather_load9,4);
...
int index_gather_load10[8] = {0,9,18,27,36,45,54,63};
__m256i vindex_gather_load10 = _mm256_load_si256((const __m256i*)index_gather_load10);
EPJ_mass = _mm256_i32gather_ps(((float*)&epj[j+0].mass),vindex_gather_load10,4);
__m256x3 EPJ_pos;
...
EPJ_pos.v0 = _mm256_i32gather_ps(((float*)&epj[j+0].pos.x),vindex_gather_load11,4);
...
EPJ_pos.v1 = _mm256_i32gather_ps(((float*)&epj[j+0].pos.y),vindex_gather_load12,4);
...
EPJ_pos.v2 = _mm256_i32gather_ps(((float*)&epj[j+0].pos.z),vindex_gather_load13,4);
__m256x3 acc_sprg_tmp;
