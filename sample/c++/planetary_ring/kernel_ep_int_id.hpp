...
r_real_sq = _mm256_fmadd_ps(rij.v2,rij.v2,_mm256_fmadd_ps(rij.v1,rij.v1,_mm256_fmadd_ps(rij.v0,rij.v0,_mm256_set1_ps(0.001f))));
...
r_real_sq = (rij.z*rij.z+(rij.y*rij.y+(rij.x*rij.x+0.001f)));
over_r_real = rsqrt(r_real_sq);
...
EPJ_id = _mm256_i32gather_epi32(((int*)&epj[j+0].id),vindex_gather_load11,4);
__m256 EPJ_mass;
