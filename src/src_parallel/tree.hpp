...
namespace ParticleSimulator{
    ...
    class EPXROnly{
        ...
        F32vec pos;
    public:
        F32 getRSearch() const { return r_search;}
        F32vec getPos() const { return pos;}
	void setPos(const F32vec & pos_in) { pos = pos_in;}
        template<class Tep>
    ...
    public:
	    ...
	    //(this->vertex_out_).merge(epj.getPos(), epj.getRSearch()*10.0);
        }
        template<class Tepj>
